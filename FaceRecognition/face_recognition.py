                ...
                if faceNum > 0:
                    ...
                    for i in range(faceNum):
                        ...
                        try:
                            ...
                            #img_org = scaled[i]
                            #cv2.imwrite("origin_image_1.jpg",img_org)
                            #aligned = align_image(img_org)
                            #aligned = None
                            #if (aligned is not None):
                            #    scaled[i] = aligned
                            #    cv2.imwrite("origin_image.jpg",img_org)
                            ...
                            if best_class_probabilities>0.87:
                                ...
                                for H_i in HumanNames:
                                    if HumanNames[best_class_indices[0]] == H_i:
                                        result_ids = HumanNames[best_class_indices[0]]
                                        result_names = "?"
                                ...
                                cv2.rectangle(frame, (xmin, ymin-20), (xmax, ymin-2), (0, 255,255), -1)
                                cv2.putText(frame, "?", (xmin,ymin-5), cv2.FONT_HERSHEY_COMPLEX_SMALL, 1, (0, 0, 0), thickness=1, lineType=1)
                        except:   
                            print("error")
